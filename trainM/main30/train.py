            ...
            for n,idx in enumerate(indices):
                ...
                for step in range(1):
                    ...
                    print('\rEpoch/img: {}/{} | LR sr/ag: {:.8f}/{:.8f} | Agent Loss: {:.4f}, SISR Loss: {:.4f}, s1: {:.4f}, s2: {:.4f}, s3: {:.4f}'\
                            .format(c,n,lr,lr2,selectionloss.item(),sisrloss.item(), s1.item(), s2.item(), s3.item()),end="\n")

                    #LOG AND SAVE THE INFORMATION
                    scalar_summaries = {'Loss/AgentLoss': selectionloss, 'Loss/SISRLoss': sisrloss, "choice/c1": c1, "choice/c2": c2, "choice/c3": c3, "sisr/s1": s1, "sisr/s2": s2, "sisr/s3": s3}
