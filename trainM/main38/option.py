...
parser.add_argument("--test_baseline",default=False,action='store_const',const=True,help='Basic test on a single lr image without corresponding hr image, and metrics')
