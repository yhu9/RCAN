...
parser.add_argument("--action_space",default=3, help='Action Space size')
...
parser.add_argument("--learning_rate",default=0.0001,type=float,help="Learning rate of Super Resolution Models")
